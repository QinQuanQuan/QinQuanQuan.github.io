...
互联网上的收藏夹只会越堆越多，而笔记写下来、连起来，才会真正变成自己的东西。所以这个站点被做成一座「数字花园」：不追求一次性写完，而是允许内容慢慢生长、不断修订。

写作原则很简单：**先写下来，再慢慢打磨**。每篇笔记都会标注自己的成熟度：
...
| 板块 | 目录 | 说明 |
| --- | --- | --- |
| 笔记 | `/notes` | 学习笔记、工具速查、读书摘录 |
| 项目 | `/projects` | 正在做的事、阶段目标与复盘 |
...
- [[astro-veka-setup]]：本站的技术选型与搭建记录。
- [[git-cheatsheet]]：日常开发的 Git 命令速查。
- [[digital-garden]]：这个站点的长期规划。
